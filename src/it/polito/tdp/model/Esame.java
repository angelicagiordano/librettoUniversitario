...
public class Esame {
	...
	//contiene dati privati, costruttore, metodi getter e setter, più i metodi di servizio--> equals, toString, hashcode, [compareTo]
	...
	/**Restituisce voto solo se l'esame è stato superato--> altrimenti eccezione
	 * @return the voto
	 */
	public int getVoto() {
		if(this.superato){
	...
	/**
	 * Se l'esame non è ancora superato, lo considera superato con la data e il voto specificati
	 * Se incece l'esame era già stato superato generiamo l'eccezione
	 * @param voto
	 * @param data
	 */
	public void supera(int voto, LocalDate data){
		if(!this.superato){
			...
			throw new IllegalStateException("Esame "+this.codice+ " già superato!");
			                                 //eccezioni a runtime, è stato chiamato un metodo quando non si deve
